...
import { Search, Filter, Grid, List, ChevronDown, ShoppingCart, Home, ChevronRight, X, Image as ImageIcon } from "lucide-react";
              ...
              return (
                <div
                  ...
                  className={`group border-2 border-gray-100 rounded-2xl bg-white hover:border-gray-300 hover:-translate-y-1 transition-all duration-300 ease-out hover:shadow-lg ${
                    viewMode === "list" ? "flex p-6" : "relative"
                  }`}
                >
                  {/* Discount Badge */}
                  {hasDiscount && (
                  ...
                  <Link
                    ...
                    className={`${
                      viewMode === "list" ? "w-48 h-32 flex-shrink-0 mr-6" : "w-full h-48 mb-4"
                    } bg-gray-50 rounded-xl flex items-center justify-center overflow-hidden`}
                  >
